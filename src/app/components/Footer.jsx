      ...
      <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
        <div className="flex flex-col md:flex-row">
          <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
            <h3 className="font-bold text-2xl">Sninaat</h3>
            ...
            <ul className="mt-4">
              <li>
                ...
                >
                  ...
                  <span className="ml-3"> 1985 Rue, Ville, Pays</span>
                </a>
              </li>
              <li className="mt-4">
                <a
              ...
              <li className="mt-4">
                ...
                >
                  ...
                  <span className="ml-3"> +212 123-456-789 </span>
                </a>
              </li>
              <li className="mt-4">
                <a
                ...
                >
                  ...
                  <span className="ml-3"> Sninaat@gmail.com </span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            ...
            <p className="text-sm text-gray-400 mt-12">
              © 2023 Sninaat. <br className="hidden lg:block" />
              All Rights Reserved.
            </p>
          </div>
        </div>
